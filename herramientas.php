...
<h2 class="text-center mb-5">Herramientas</h2>
...
<h5><?= $fila['nombre'] ?></h5>
<p class="text-muted">Código: <?= $fila['codigo'] ?? $fila['id'] ?></p>
...
<p class="fw-bold">Debes iniciar sesión para comprar</p>
...
// 🔥 BADGE UPDATE (AQUÍ ESTABA EL FALTANTE)
