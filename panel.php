...
@keyframes fadeInPage {
    from {
        opacity: 0;
        transform: translateY(15px); /* opcional */
    }
    to {
        opacity: 1;
...
/* Oscurecido suave para el texto */
.carousel-item::after {
    content: "";
    position: absolute;
    inset: 0;
...
<div class="container-fluid my-5 px-0">
    ...
    <div class="text-center mb-4">
        ...
        <div class="section-title text-dark">Promociones y Novedades</div>
    </div>

    <div id="carouselFerreteria" class="carousel carousel-fade shadow rounded overflow-hidden"
     ...
     data-bs-interval="5000">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
                <img src="img/prof.jpg" class="d-block w-100" style="height:420px; object-fit:cover;" alt="Herramientas">
            ...
            <div class="carousel-item">
                <img src="img/mate.jpg" class="d-block w-100" style="height:420px; object-fit:cover;" alt="Construcción">
                <div class="carousel-caption d-none d-md-block bg-dark bg-opacity-50 rounded p-3">
            ...
            <div class="carousel-item">
                <img src="img/broc.jpg" class="d-block w-100" style="height:420px; object-fit:cover;" alt="Pinturas">
                <div class="carousel-caption d-none d-md-block bg-dark bg-opacity-50 rounded p-3">
